...
//==============================================================================
inline void addInt(juce::AudioProcessorValueTreeState::ParameterLayout& layout, const juce::String& identifier, int defaultValue, juce::NormalisableRange<int> range) { layout.add(std::make_unique<AudioParameterInt>(identifier, identifier, range.start, range.end, defaultValue)); };
inline void addFloat(juce::AudioProcessorValueTreeState::ParameterLayout& layout, const juce::String& identifier, float defaultValue, juce::NormalisableRange<float> range) { layout.add(std::make_unique<AudioParameterFloat>(identifier, identifier, range, defaultValue)); };
inline void addBool(juce::AudioProcessorValueTreeState::ParameterLayout& layout, const juce::String& identifier, bool defaultValue) { layout.add(std::make_unique<AudioParameterBool>(identifier, identifier, defaultValue)); };
inline void addChoice(juce::AudioProcessorValueTreeState::ParameterLayout& layout, const juce::String& identifier, int defaultIndex, const juce::StringArray& choicesToUse) { layout.add(std::make_unique<AudioParameterChoice>(identifier, identifier, choicesToUse, defaultIndex)); };
